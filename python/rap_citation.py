...
def make_request(artist):
    ...
    with open(path.normpath(f'csv_files//rap_citation//{artist}.csv'), mode='w', newline="", encoding="UTF-8") as csv_file:
...
def get_citation(artist):
    ...
    citations_list = []
    with open(path.normpath(f'csv_files//rap_citation//{artist}.csv'), mode='r', encoding="UTF-8") as csv_file:
